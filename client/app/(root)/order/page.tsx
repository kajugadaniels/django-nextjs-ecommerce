...
const order = () => {
    return (
        <div className='bg-gray-50'>
            <h2 className="text-3xl font-extrabold text-gray-900 text-center pt-44">Order Detail</h2>
                ...
                <div className="flex justify-between items-center mb-4">
                    <div className="flex space-x-2">
                        <input
                            ...
                            className="bg-white text-gray-600 px-12 py-3 border rounded-l focus:outline-none"
                        />
                    ...
                    <div className="flex space-x-4">
                        <select className="bg-white text-gray-500 px-4 py-2 border rounded">
