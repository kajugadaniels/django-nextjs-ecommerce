...
const Footer = () => {
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-emerald-800 focus:text-emerald-800"> Home </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-emerald-800 focus:text-emerald-800"> About us </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-emerald-800 focus:text-emerald-800"> Shop </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-emerald-800 focus:text-emerald-800"> Contact us </a>
                    </li>
                </ul>
            </div>
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Send your email</p>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by E-GREEN</p>
    </div>
</section>
  )
}
