        ...
        <div className="relative pt-12 bg-gray-50 sm:pt-16 lg:py-36 xl:py-48">
            ...
            <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-lg mx-auto text-center lg:mx-0 lg:max-w-md lg:text-left">
                    <p className="text-base font-bold text-white lg:text-white sm:text-gray-900">Fresh, Quality Products Delivered to Your Doorstep</p>
                    <h1 className="mt-3 text-2xl font-bold lg:text-white sm:mt-8 sm:text-3xl xl:text-5xl sm:text-black">Discover the Best Selection of Long-Lasting Produce.</h1>
