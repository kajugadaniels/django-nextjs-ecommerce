                ...
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl ">
                    <div className="flex items-center justify-between h-24 lg:h-[72px]">
                        ...
                        <div className="flex items-center flex-shrink-0 ml-4 lg:ml-0">
                            <Link href="/" title="" className="inline-flex rounded focus:outline-none text-white">
                                E-Greene
                            </Link>
                        </div>
                        ...
                        <div className="flex items-center justify-end ml-auto">
                            <div className="hidden lg:flex lg:items-center lg:space-x-8 ">
                                <SignedOut>
                                    <Link href="/sign-in" title="" className="text-base font-medium text-white transition-all duration-200 rounded hover:text-gray-700 focus:outline-none"> Login </Link>
                                    <Link href="/sign-up" title="" className="text-base font-medium text-white transition-all duration-200 rounded hover:text-gray-700 focus:outline-none"> Register </Link>
                                </SignedOut>
                            </div>
