    ...
    return (
        <div className="w-full md:max-w-sm">
            <div className="box rounded-xl border border-gray-300 bg-white p-6 w-full">
                ...
                <label htmlFor="zipCode" className="block mb-2 text-sm font-medium text-gray-600 w-full">Zip Code</label>
                    ...
                    <div className='accordion-group grid grid-cols-1 gap-5 sm:gap-9'
                        ...
                        <div className='accordion '
                            ...
                            <button
                                ...
                                <svg className={`text-gray-900 transition duration-500 group-hover:text-indigo-600 accordion-active:text-indigo-600 ${dropdownOpen ? 'rotate-180' : ''}`}
